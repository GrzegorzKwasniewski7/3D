    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: 'E:/Edu/UJ/Programowanie_3d/3d-main/out/build/x64-Debug (default)/_deps/glm-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/Edu/UJ/Programowanie_3d/3d-main/out/build/x64-Debug (default)/_deps/glm-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
